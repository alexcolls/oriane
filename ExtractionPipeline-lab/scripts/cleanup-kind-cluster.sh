...
docker image rm pipeline-api-test:latest 2>/dev/null || echo "Image pipeline-api-test:latest not found"
docker image rm pipeline-api:latest 2>/dev/null || echo "Image pipeline-api:latest not found"
...
echo "All KinD cluster resources have been removed."
